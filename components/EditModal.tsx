      ...
      <div className="bg-gray-900 border border-gray-700 rounded-xl shadow-2xl w-full max-w-2xl relative flex flex-col max-h-[90vh]">
          ...
          <form id="edit-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gray-800/50 p-4 rounded-lg border border-gray-700">
              ...
              {imageMode === 'url' ? (
                ...
                <div className="text-center border-2 border-dashed border-gray-600 rounded-lg p-4 hover:border-gray-400 transition cursor-pointer relative">
                  <input 
                    type="file" 
                    accept="image/*"
        ...
        <div className="p-4 md:p-6 border-t border-gray-800 flex justify-end gap-3 bg-gray-900">
          ...
          <button 
            form="edit-form"
            type="submit"
            className="bg-brand-red hover:bg-red-700 text-white font-bold py-2 px-6 rounded flex items-center gap-2"
          >
