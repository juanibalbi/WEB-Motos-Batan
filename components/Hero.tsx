...
const Hero: React.FC = () => {
  return (
    <div className="relative bg-brand-dark overflow-hidden min-h-[65vh] md:min-h-[500px] flex items-center lg:block lg:min-h-0">
      <div className="max-w-7xl mx-auto w-full h-full flex items-center">
        <div className="relative z-10 w-full pb-8 bg-transparent lg:bg-brand-dark sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 pt-24 lg:pt-0 px-4 sm:px-6 lg:px-8">
          ...
          <main className="mt-0 mx-auto max-w-7xl relative z-20 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="mt-8 w-full sm:max-w-lg flex flex-col gap-4">
              {/* Catalog Button */}
              <a
                href="#catalogo"
                className="w-full flex items-center justify-center px-8 py-4 border border-transparent text-lg font-black rounded-lg text-brand-dark bg-white hover:bg-gray-200 uppercase tracking-widest transition-transform active:scale-95 shadow-xl"
              >
                Ver Catálogo
              </a>
              ...
              <a
                ...
                className="w-full relative overflow-hidden flex flex-col items-center justify-center px-6 py-4 border-2 border-brand-red bg-brand-red hover:bg-red-700 text-white rounded-lg transition-all active:scale-95 shadow-xl shadow-red-900/40 group"
              >
                <div className="absolute -right-6 -top-6 text-red-900 opacity-40 transform rotate-12 group-hover:rotate-0 transition-transform">
                  <CreditCard size={100} />
                </div>
                
                <span className="relative z-10 font-black text-xl italic uppercase tracking-wider leading-none mb-1 flex items-center gap-2 drop-shadow-md">
                   CALIFICÁ EN 1 MINUTO <ChevronRight className="animate-pulse" />
                </span>
                <span className="relative z-10 text-sm font-bold opacity-90 mb-2 uppercase tracking-wide">
                  A NUESTRO FINANCIAMIENTO
                </span>
                
                <div className="relative z-10 bg-black/40 px-4 py-1 rounded-full border border-white/10 shadow-sm">
                  <span className="text-xs md:text-sm font-bold tracking-widest uppercase text-white">
                    Hasta 36 cuotas fijas y en pesos
                  </span>
                </div>
              </a>
            </div>
